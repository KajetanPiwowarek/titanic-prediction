...
def main():
	...
	st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Olympic_and_Titanic.jpg/1280px-Olympic_and_Titanic.jpg")

	with overview:
		st.title("Czy przeżyłbyś katastrofę tytanica")
